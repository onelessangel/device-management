...
import com.example.Device.Management.design.device.DeviceController;
...
public class DeviceControllerTests {
    ...
    public void testFindAllDevices_emptyDB() {
        List<DeviceDTO> devices = controller.findAll();
    ...
    public void testFindAllDevices() throws ParseException {
        ...
        controller.save(device1);
        controller.save(device2);
        controller.save(device3);

        List<DeviceDTO> customers = controller.findAll();
    ...
    public void testFindById() throws ParseException {
        ...
        String id = controller.save(device);
        assertEquals("D8:13:13:1F:4C:F5", controller.findById(Long.parseLong(id)).getMacAddr());
    }
    ...
    public void testDeleteByMacAddr() throws ParseException {
        ...
        controller.deleteByMacAddr(device.getMacAddr());
        assertEquals(0, controller.findAll().size());
    }
    ...
    public void testDeleteBySerial() throws ParseException {
        ...
        controller.deleteBySerial(device.getSerial());
        assertEquals(0, controller.findAll().size());
    }
    ...
    public void testUpdateById() throws ParseException {
        ...
        String idDevice1 = controller.save(device1);
        assertNotNull(controller.findById(Long.parseLong(idDevice1)));

        controller.updateById(Long.valueOf(idDevice1), device2);
        assertNotEquals(device1.getMacAddr(), controller.findById(Long.parseLong(idDevice1)).getMacAddr());
    }
    ...
    public void testUpdateByMacAddress() throws ParseException {
        ...
        controller.updateByMacAddress(device1.getMacAddr(), device2);
        assertNotEquals(device1.getMacAddr(), controller.findById(Long.parseLong(idDevice1)).getMacAddr());
    }
    ...
    public void testUpdateBySerial() throws ParseException {
        ...
        controller.updateBySerial(device1.getSerial(), device2);
        assertNotEquals(device1.getMacAddr(), controller.findById(Long.parseLong(idDevice1)).getMacAddr());
    }
}
